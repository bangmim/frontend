      ...
      <div style={{ textAlign: 'center', marginTop: '150px' }}>
        ...
        <div>
          <Box sx={{ minWidth: 120 }} >
            ...
            <button className="ui animated button" onClick={toggleVisibility} style={{ borderRadius: '50%', height: '30px', width: '30px', marginTop: '20px', backgroundColor: "black" }} >
              <div className="visible content"></div>
              <div className="hidden content">
                <i aria-hidden="true" className="search icon" style={{ paddingLeft: '4px', color: 'white' }}></i>
              </div>
            </button>
          </Box>
          <Divider hidden />
          <div className='flex'>
            <Transition visible={visible} animaiton='drop' duration={800} >
              <Button className="ui icon button fade visible transition" style={{ backgroundColor: "white", color: "black" }} onClick={handlerest} size='big'>
                <Icon name='close' />
              </Button>
            </Transition>
          </div>
